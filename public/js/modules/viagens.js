...
(function() {
    ...
    function renderViagens(container) {
        ...
        async function openViagemDetailModal(tripId) {
            const currentTrips = window.movixStore.getViagens();
                    ...
                    <div class="grid-1-1" style="display: grid; grid-template-columns: 1.2fr 1fr; gap: 24px;">
                        <div>
                            ...
                            <div style="margin-top:20px;">
                                <h5 style="font-weight:700; margin-bottom:8px; font-size:0.85rem;"><i class="fa-solid fa-paperclip"></i> Anexos de Checklist:</h5>
                                <div style="display:flex; flex-direction:column; gap:8px;">
                                    ${t.fotoInicial ? `
                                        <div style="display:flex; align-items:center; justify-content:space-between; border-bottom:1px solid var(--border-light); padding:4px 0;">
                                            <span style="font-size:0.8rem; color:var(--text-main);">Checklist de Saída</span>
                                            <a href="${t.fotoInicial}" target="_blank" class="btn btn-secondary" style="padding:4px 8px; font-size:0.75rem; display:inline-flex; align-items:center; gap:4px; text-decoration:none;">
                                    ...
                                    ${t.fotoFinal ? `
                                        <div style="display:flex; align-items:center; justify-content:space-between; border-bottom:1px solid var(--border-light); padding:4px 0;">
                                            <span style="font-size:0.8rem; color:var(--text-main);">Checklist de Retorno</span>
                                            <a href="${t.fotoFinal}" target="_blank" class="btn btn-secondary" style="padding:4px 8px; font-size:0.75rem; display:inline-flex; align-items:center; gap:4px; text-decoration:none;">
                                                <i class="fa-solid fa-paperclip"></i> Ver Anexo
                                            </a>
                                        </div>
                                    ` : ''}
